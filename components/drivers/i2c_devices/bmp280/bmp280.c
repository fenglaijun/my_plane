...
static struct bmp280_t p_bmp280 = {0}; /**< pointer to BMP280 */
 ...
 *
 */
BMP280_RETURN_FUNCTION_TYPE bmp280_init(I2C_Dev *i2cPort)
{
    if (isInit) {
        return true;
    }
	...
	I2Cx = i2cPort;
	devAddr = BMP280_I2C_ADDRESS_LOW;

//	p_bmp280 = bmp280;/* assign BMP280 ptr */
	/* read chip id */

	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CHIP_ID_REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
		...
		int32_t *v_uncomp_temperature_s32)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_TEMPERATURE_MSB_REG, BMP280_TEMPERATURE_DATA_LENGTH, &a_data_u8r);
		...
		int32_t *v_uncomp_pressure_s32)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_PRESSURE_MSB_REG, BMP280_PRESSURE_DATA_LENGTH, &a_data_u8);
		...
		int32_t *v_uncomp_pressure_s32, int32_t *v_uncomp_temperature_s32)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_PRESSURE_MSB_REG, BMP280_DATA_FRAME_SIZE, &a_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_calib_param(void)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_TEMPERATURE_CALIB_DIG_T1_LSB_REG, BMP280_PRESSURE_TEMPERATURE_CALIB_DATA_LENGTH, &a_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_oversamp_temperature(uint8_t *v_value_u8)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_OVERSAMP_TEMPERATURE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_oversamp_temperature(uint8_t v_value_u8)
{
	...
	if (com_rslt == 1) {
		...
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_OVERSAMP_TEMPERATURE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_oversamp_pressure(uint8_t *v_value_u8)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_OVERSAMP_PRESSURE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_oversamp_pressure(uint8_t v_value_u8)
{
	...
	if (com_rslt == 1) {
		...
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_OVERSAMP_PRESSURE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_power_mode(uint8_t *v_power_mode_u8)
{
	...
	/* read the power mode*/
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_POWER_MODE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_mode_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_power_mode(uint8_t v_power_mode_u8)
{
	...
	if (v_power_mode_u8 <= BMP280_NORMAL_MODE) {
		...
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG_POWER_MODE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_mode_u8);
	} else {
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_soft_rst(void)
{
	...
	/* write soft reset */
	com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_RST_REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_spi3(uint8_t *v_enable_disable_u8)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CONFIG_REG_SPI3_ENABLE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_spi3(uint8_t v_enable_disable_u8)
{
	...
	if (com_rslt == 1) {
		...
		v_data_u8 = BMP280_SET_BITSLICE(v_data_u8,
				BMP280_CONFIG_REG_SPI3_ENABLE,
				v_enable_disable_u8);
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CONFIG_REG_SPI3_ENABLE__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
	}
	return com_rslt;
}
/*!
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_filter(uint8_t *v_value_u8)
{
	...
	uint8_t v_data_u8 = BMP280_INIT_VALUE;
		/* read filter*/
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CONFIG_REG_FILTER__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_filter(uint8_t v_value_u8)
{
	...
	if (com_rslt == 1) {
		...
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CONFIG_REG_FILTER__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_get_standby_durn(uint8_t *v_standby_durn_u8)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CONFIG_REG_STANDBY_DURN__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_standby_durn(uint8_t v_standby_durn_u8)
{
	...
	if (com_rslt == 1) {
		...
		com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CONFIG_REG_STANDBY_DURN__REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
	}
...
BMP280_RETURN_FUNCTION_TYPE bmp280_set_work_mode(uint8_t v_work_mode_u8)
{
	...
	if (v_work_mode_u8 <= BMP280_ULTRA_HIGH_RESOLUTION_MODE) {
		...
		com_rslt = i2cdevReadReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
		...
		if (com_rslt == 1) {
			...
			com_rslt = i2cdevWriteReg8(I2Cx, devAddr, BMP280_CTRL_MEAS_REG, BMP280_GEN_READ_WRITE_DATA_LENGTH, &v_data_u8);
		}
	} else {
		com_rslt = E_BMP280_OUT_OF_RANGE;
	}
		...
		uint8_t v_len_u8)
{
	...
	com_rslt = i2cdevWriteReg8(I2Cx, devAddr, v_addr_u8, v_len_u8, &v_data_u8);
		...
		uint8_t v_len_u8)
{
	...
	com_rslt = i2cdevReadReg8(I2Cx, devAddr, v_addr_u8, v_len_u8, &v_data_u8);
	return com_rslt;
}
 ...
 *	@note Output value of "963.862"is 963.862 hPa.
 *
 *
 *
 *  @param v_uncomp_pressure_s32 : value of uncompensated pressure
 ...
 *
 */
bool bmp280_read_pressure_temperature_float(
		float *v_pressure_f,float *v_temperature_f, float *asl)
{
	/* variable used to return communication result*/
	BMP280_RETURN_FUNCTION_TYPE com_rslt = ERROR;
	int32_t v_uncomp_pressure_s32 = BMP280_INIT_VALUE;
	...
	*v_temperature_f = bmp280_compensate_temperature_float(
			v_uncomp_temperature_s32);
	*v_pressure_f = bmp280_compensate_pressure_float(
			v_uncomp_pressure_s32);

	*asl = bmp280PressureToAltitude(v_pressure_f);
...
#define LPS25H_ST_PRESS_MAX   (1100.0f) //mbar=hpa
#define LPS25H_ST_PRESS_MIN   (450.0f)  //mbar=hpa
...
bool bmp280SelfTest(void)
{
  ...
  bmp280_read_pressure_temperature_float(&pressure, &temperature, &asl);

  if (bmp280EvaluateSelfTest(LPS25H_ST_PRESS_MIN, LPS25H_ST_PRESS_MAX, pressure, "pressure") &&
		  bmp280EvaluateSelfTest(LPS25H_ST_TEMP_MIN, LPS25H_ST_TEMP_MAX, temperature, "temperature"))
  {
	  return true;
  }
  else
 ...
 */
float bmp280PressureToAltitude(float* pressure/*, float* ground_pressure, float* ground_temp*/)
{
    if (*pressure > 0)
    {
